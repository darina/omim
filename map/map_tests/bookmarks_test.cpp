...
UNIT_TEST(Bookmarks_Sorting)
{
  ...
  auto & addressGetter = fm.GetRegionAddressGetter();
  auto const kMoscowCenter = MercatorBounds::FromLatLon(55.750441, 37.6175138);

  auto const addrMoscow = addressGetter.GetLocalizedRegionAdress(kMoscowCenter);
  ...
  BookmarkManager::SortedBlocksCollection expectedSortedByDistance = {
    {BookmarkManager::GetNearMeBlockName(), {8, 6, 4, 2, 1, 0}},
    {addrMoscow, {3, 5, 10, 12, 7, 9}},
    {BookmarkManager::GetOthersBlockName(), {11}}};
  ...
  BookmarkManager::SortedBlocksCollection expectedSortedByType = {
    ...
    {BookmarkManager::GetOthersBlockName(), {8, 11, 7}}};
  ...
  auto const addrBerlin = addressGetter.GetLocalizedRegionAdress(kBerlin1);
  auto const addrMinsk = addressGetter.GetLocalizedRegionAdress(kMinsk1);
  auto const addrGreenland = addressGetter.GetLocalizedRegionAdress(kGreenland);
  auto const addrWashington = addressGetter.GetLocalizedRegionAdress(kWashington);
  auto const addrKathmandu = addressGetter.GetLocalizedRegionAdress(kKathmandu);
  auto const addrVladimir = addressGetter.GetLocalizedRegionAdress(kVladimir);
  auto const addrBermuda = addressGetter.GetLocalizedRegionAdress(kBermuda);
  ...
  BookmarkManager::SortedBlocksCollection expectedSortedByType2 = {
    ...
    {BookmarkManager::GetOthersBlockName(), {112, 102, 101}}};
  ...
  BookmarkManager::SortedBlocksCollection expectedSortedByType4 = {
    ...
    {BookmarkManager::GetOthersBlockName(), {304, 303, 302, 301, 300}}};
...

  {
    ...
    auto const sortingTypes = bmManager.GetAvailableSortingTypes(catId, true, myPos);
    TEST(sortingTypes == expectedSortingTypes, ());

    auto const sortedByTime = bmManager.GetSortedBookmarkIds(catId, BookmarkManager::SortingType::ByTime, true, myPos);
    printBlocks("Sorted by time", sortedByTime);
    TEST(sortedByTime == expectedSortedByTime, ());

    auto const sortedByType = bmManager.GetSortedBookmarkIds(catId, BookmarkManager::SortingType::ByType, true, myPos);
    printBlocks("Sorted by type", sortedByType);
    TEST(sortedByType == expectedSortedByType, ());

    auto const sortedByDistance = bmManager.GetSortedBookmarkIds(catId, BookmarkManager::SortingType::ByDistance,
                                                                 true, myPos);
...

  {
    ...
    auto const sortingTypes2 = bmManager.GetAvailableSortingTypes(catId2, true, myPos2);
    ...
    auto const sortedByType2 = bmManager.GetSortedBookmarkIds(catId2, BookmarkManager::SortingType::ByType, false, {});
    printBlocks("Sorted by type 2", sortedByType2);
    TEST(sortedByType2 == expectedSortedByType2, ());

    auto const sortedByDistance2 = bmManager.GetSortedBookmarkIds(catId2, BookmarkManager::SortingType::ByDistance,
                                                                  true, myPos2);
...

  {
    ...
    auto const sortedByType4 = bmManager.GetSortedBookmarkIds(catId4, BookmarkManager::SortingType::ByType, false, {});
